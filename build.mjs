...
// Mark the CLI executable so `./dist/index.js` runs directly. chmod is a no-op
// on Windows (no POSIX permission bits), so guard it to keep the build portable.
if (process.platform !== 'win32') {
  fs.chmodSync(builtFile, 0o755);
}
